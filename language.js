...
// Login Popup
if (document.getElementById("login_title")) {

  document.getElementById("login_title").textContent =
    translations[lang].login_title;

  document.getElementById("login_email_label").textContent =
    translations[lang].login_email;

  document.getElementById("login_password_label").textContent =
    translations[lang].login_password;

  document.getElementById("login-btn").textContent =
    translations[lang].login_btn;

  document.getElementById("login_no_account_text").childNodes[0].textContent =
    translations[lang].login_no_account + " ";

  document.getElementById("register_now_link").textContent =
    translations[lang].register_now;


  // Register
  document.getElementById("register_title").textContent =
    translations[lang].register_title;

  document.getElementById("register_username_label").textContent =
    translations[lang].register_username;

  document.getElementById("register_email_label").textContent =
    translations[lang].register_email;

  document.getElementById("register_password_label").textContent =
    translations[lang].register_password;

  document.getElementById("reg-btn").textContent =
    translations[lang].register_btn;

  document.getElementById("already_have_account_text").childNodes[0].textContent =
    translations[lang].already_have_account + " ";

  document.getElementById("login_now_link").textContent =
    translations[lang].login_now;
}
if (document.getElementById("open_login_btn")) {
  document.getElementById("open_login_btn").textContent =
    translations[lang].open_login_btn;
}
